...
<!-- Mirrored from axilthemes.com/demo/template/papr/post-format-text-only.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Feb 2020 15:41:09 GMT -->
<head>
    <!-- Basic metas
		======================================== -->
    <meta charset="utf-8">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="has-dropdown is-active">
                                        ...
                                        <ul class="submenu">
                                            ...
                                            <li class="is-active"><a href="post-format-text-only.html">Post Format
                                                    Text Only</a>
                                            </li>
                                        </ul>
                                        <!-- End of .submenu -->
